...
echo.
echo Make sure you inputted new and correct data to data/tillBalance
if %dataCorrect%==0 echo WARNING: data/tillBalance hasn't been updated in over a day, please update!
echo Make sure data/scannedTills is up todate!
...
if %count%==0 set /p amount=< tillBalance.txt
